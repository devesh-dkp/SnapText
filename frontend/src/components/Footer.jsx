    ...
    <>
      ...
      <div className="flex flex-wrap justify-between text-black">
        <div className="flex flex-wrap justify-left px-5 mb-5 bottom-0">
          <a
            className="text-black bg-white cursor-pointer hover:text-gray-800 mx-2"
            onClick={() =>
              (window.location.href = "https://linkedin.com/in/deveshkpandey")
            }
          >
            <img
              alt="linkedin"
          ...
          <a
            className="text-black bg-white cursor-pointer hover:text-gray-800 mx-2"
            onClick={() =>
              (window.location.href = "https://www.youtube.com/@devesh_pandey")
            }
          >
            <img
              alt="youtube"
          ...
          <a
            className="text-black bg-white cursor-pointer hover:text-gray-800 mx-2"
            onClick={() =>
              (window.location.href = "https://x.com/pandey_devesh_")
            }
          >
            <img
              alt="twitter"
              src="https://img.icons8.com/color/48/000000/twitterx--v2.png"
            />
          </a>
        </div>
        {/* <div className="flex flex-wrap justify-center text-black px-5"> */}
        <div className="flex flex-wrap font-bold text-black mx-2">
          Made by&nbsp;
          <a
